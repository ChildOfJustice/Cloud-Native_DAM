    ...
    render(){
        return (
            <tr >
                ...
                <td>
                    <Button onClick={() => this.props.handleDownloadFile(this.props.value.file.S3uniqueName, this.props.value.file.cloud, this.props.value.file.name)}>
                ...
                <td>
                    <input key={this.props.value.id} onChange={this.props.handleCheckChildElement} type="checkbox" checked={this.props.value.isChecked} />
                </td>
                {/*<td>*/}
